...
export default function InfiniteCluesAccordion(itinierary: ItineraryItem[]) {
  // --- Initial clues ---
...
//   ]);
    ...
    // const items: ItineraryItem[] = React.useState(itinierary)
...
//   };
  ...
  return (
    <div className="mx-auto w-full max-w-xl p-4">
      ...
      >
        {itinierary.map(({ stop_number }) => {
          const isRevealed = revealed.has(stop_number);
          return (
            <AccordionItem
              key={stop_number}
              value={stop_number}
                ...
                <div className="rounded-xl border bg-background/50 p-4">
                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() => toggleReveal(stop_number)}
                    >
